...
import { X, Save, Download, Key, AlertCircle, CheckCircle, Loader2, Edit, Image as ImageIcon, Zap, Phone, User, ChevronDown } from 'lucide-react';
...
export default function VCardEditModal({ isOpen, onClose, initialSlug }: VCardEditModalProps) {
    ...
    const [activeSection, setActiveSection] = useState<string | null>('perfil');
                                        ...
                                        <AnimatePresence>
                                            {activeSection === 'hero' && (
                                                ...
                                                >
                                                    <div className="p-6 space-y-6">
                                                        <div className="space-y-1">
                                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Texto del Botón</label>
                                                            <input 
