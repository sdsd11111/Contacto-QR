    ...
    return (
        <section className="relative w-full min-h-[70vh] flex items-center" style={{ background: DARK }}>
            ...
            <div className="absolute inset-0 overflow-hidden">
                <img src={bg} alt="Hero" className="w-full h-full object-cover object-center" style={{ opacity: 0.65 }} />
    ...
    return (
        <section className="py-16 px-4" style={{ background: '#f5f5f5' }}>
            <div className="max-w-6xl mx-auto">
                ...
                <h2 className="text-3xl md:text-5xl font-black text-center uppercase mb-12" style={{ color: DARK }}>
                    Nuestros Productos
                </h2>
        ...
        <section id="nosotros" className="py-20 px-4" style={{ background: '#f9f9f9' }}>
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-14">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black uppercase mb-6" style={{ color: DARK }}>
