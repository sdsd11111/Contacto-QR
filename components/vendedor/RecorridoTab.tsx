...
function generarMensaje(category: string, objection: string, businessName: string, contactName: string, sellerName: string): string {
    ...
    const base: Record<string, string> = {
        ...
        medico: `Hola ${saludo}soy ${nombre} de ActivaQR. Le visité en ${businessName}.${objStr} Su tarjeta digital haría que sus pacientes lo encuentren sin esfuerzo. ¿Podemos coordinar una breve llamada?`,
