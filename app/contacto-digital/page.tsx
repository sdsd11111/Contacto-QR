...
// Datos del Slider "El Espejo"
const EL_ESPEJO_SLIDES = [
  {
    img: "/images/Reingenierìa/secuencia_urbana_1_valla.webp",
  ...
  {
    img: "/images/Reingenierìa/v2_tarjetas_mano.webp",
  ...
  {
    img: "/images/Reingenierìa/v2_promotor_repartiendo.webp",
  ...
  {
    img: "/images/Reingenierìa/feature_audit_1.webp",
  ...
  return (
    <main className="bg-[#0a0a0a] min-h-screen font-sans selection:bg-[#FF6B2B] selection:text-white" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="relative h-screen flex items-center justify-center bg-[#0a0a0a] overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.65] grayscale" style={{ backgroundImage: "url('/images/Reingenierìa/v2_home_page_caos_vortice.webp')" }} />
      ...
      <section className="relative py-32 md:py-48 flex items-end bg-[#0a0a0a]">
        <ScatteredPings />
        <div className="absolute inset-0 bg-cover bg-center opacity-40 bg-fixed grayscale" style={{ backgroundImage: "url('/images/Reingenierìa/feature_audit_1.webp')" }} />
