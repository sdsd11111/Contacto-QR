...
const EL_ESPEJO_SLIDES = [
  {
    img: "/images/Reingenierìa/slide_activaqr2/slide1_restaurante_falla.webp",
  ...
  {
    img: "/images/Reingenierìa/slide_activaqr2/slide2_oficina_vacia.webp",
  ...
  {
    img: "/images/Reingenierìa/slide_activaqr2/slide3_hotel_pasillo.webp",
  ...
  {
    img: "/images/Reingenierìa/slide_activaqr2/slide5_cierre_negocio.webp",
    ...
    <FadeInUp delay={index * 0.1} className="group cursor-pointer">
      <div onClick={onClick} className="flex flex-col gap-4 p-8 bg-[#111111] border border-[#222222] hover:border-[#FF6B2B] transition-all duration-300 rounded-sm">
        ...
        <div className="aspect-video bg-[#0a0a0a] relative flex items-center justify-center overflow-hidden rounded-sm group-hover:scale-[1.02] transition-transform duration-500">
          <div className="absolute inset-0 bg-cover bg-center opacity-[0.65] grayscale group-hover:grayscale-0 transition-all" style={{ backgroundImage: `url('/images/Reingenierìa/plan_catalogo_notificaciones.webp')` }} />
...
export default function ContactoBusinessV2Page() {
  ...
  return (
    <main className="bg-[#0a0a0a] min-h-screen font-sans selection:bg-[#FF6B2B] selection:text-white" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="relative h-screen flex items-center justify-center bg-[#0a0a0a] overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.65] grayscale" style={{ backgroundImage: "url('/images/Reingenierìa/plan_business_estres.webp')" }} />
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center bg-[#000000] overflow-hidden">
        <RadarPing />
        <ScatteredPings />
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.65] grayscale" style={{ backgroundImage: `url('/images/Reingenierìa/v2_plan_business_indiferencia.webp')` }} />
      ...
      <section className="relative py-32 bg-[#000000] overflow-hidden border-t border-[#111111]">
        <ScatteredPings />
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.65] grayscale" style={{ backgroundImage: `url('/images/Reingenierìa/bg_messy_desk_vs_digital.webp')` }} />
