                    ...
                    <div className="grid lg:grid-cols-12 gap-16 items-center">
                        ...
                        >
                            ...
                            <div className="relative aspect-video rounded-[2.5rem] overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border-4 border-white/10 bg-white/5 mb-10 group">
                                <iframe
                                    src="https://iframe.mediadelivery.net/embed/636136/a62c1404-f58c-4a31-ae10-f1cda52877ea?autoplay=false&loop=false&muted=false&preload=true&responsive=true"
                                    loading="lazy"
                                    title="Oportunidad de Negocio ActivaQR — Únete como distribuidor"
