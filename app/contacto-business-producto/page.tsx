...
export default function ContactoBusinessMicroFunnel() {
      ...
      <StepWrapper isVisible={step === 1}>
        <div className="absolute inset-0 z-0">
          <motion.div 
            ...
            style={{ backgroundImage: "url('/images/Reingenierìa/plan_business_estres.webp')" }}
          />
        ...
        <div className="container mx-auto px-12 md:px-20 text-left max-w-6xl relative z-10 pt-20">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter leading-[1.1] max-w-2xl uppercase">
            ...
            <span className="text-white/40 italic">actualizable en segundos.</span>
          </h1>
          <p className="text-white/60 text-base md:text-lg font-bold mb-10 uppercase tracking-[0.2em] max-w-xl">
            Toma el control de tu identidad profesional y deja de depender de técnicos.
          </p>
          <button 
            onClick={() => setStep(2)}
          ...
          >
            Activar mi Plan Business <ArrowRight size={24} />
          </button>
        </div>
      </StepWrapper>
      ...
      <StepWrapper isVisible={step === 2}>
        <div className="container mx-auto px-6 text-center max-w-4xl py-20">
          <p className="text-white/40 text-[10px] font-black uppercase tracking-widest mb-4">
            Mira cómo el Plan Business escala tu marca.
          </p>
          <h2 className="text-2xl md:text-4xl font-black mb-12 tracking-tighter uppercase">Asesoría Personalizada Incluida</h2>
      ...
      {step === 3 && (
        ...
        >
          <div className="w-full max-w-5xl">
            <RegisterWizard paymentFirst={true} initialPlan="business" />
          </div>
        </motion.div>
      )}
